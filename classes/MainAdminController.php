...
EOT;
    ...
    private function getArticleFromParameters()
    {
        ...
        if (!isset($_POST['realblog_date'])
        || $_POST['realblog_date'] !== (!empty($_POST['realblog_date_old'])
                                            ? $_POST['realblog_date_old']
                                            : '')) {
        ...
        $article->feedable = (bool) (!empty($_POST['realblog_rssfeed'])
                                        ? $_POST['realblog_rssfeed']
                                        : '');
        $article->commentable = (bool) (!empty($_POST['realblog_comments'])
                                            ? $_POST['realblog_comments']
                                            : '');
